        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FooterAboutText = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    HomeDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HomeImage = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HomeBgImage = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WoringProsessSteps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserImg = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
